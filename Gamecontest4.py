...
for i in range(10):
    ...
    if player1_value > player2_value:
        print("player 1 wins-->You can play football")
    ...
    elif player3_value > player2_value:
        print("player 3 wins-->You can play KickTheBuddy")
        player2_score = player2_score + 1
    else:
        print("It's a draw-->stop playing")
    if player4_value > player3_value:
        print("player 4 wins-->You can play football")
        player4_score = player3_score + 1  # This is how we increment a variable
    elif player3_value > player4_value:
        print("player 3 wins-->You can play KickTheBuddy")
        player2_score = player2_score + 1
    else:
        print("It's a draw-->stop playing")
